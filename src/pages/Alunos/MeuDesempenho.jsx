    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-indigo-200 to-blue-100 py-12 px-4 sm:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 hover:shadow-2xl transition-all transform hover:scale-105 ease-in-out duration-300">
            <div className="flex flex-col items-center">
              ...
              <button className="bg-[#6a0dad] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-lg font-semibold transition-transform transform hover:scale-105 hover:bg-[#5a0ca3] duration-300">
                Acessar Notas
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 hover:shadow-2xl transition-all transform hover:scale-105 ease-in-out duration-300">
            <div className="flex flex-col items-center">
              <FaFilePdf className="text-[#6a0dad] text-5xl sm:text-6xl mb-4" />
              <h2 className="text-xl sm:text-2xl font-semibold text-[#6a0dad] mb-4 text-center">Relatórios</h2>
              <p className="text-gray-700 text-center text-sm sm:text-base mb-4">
                Gere um relatório PDF com o desempenho acadêmico em um período específico.
              </p>
              <button className="bg-[#6a0dad] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-lg font-semibold transition-transform transform hover:scale-105 hover:bg-[#5a0ca3] duration-300">
                Gerar Relatório
              </button>
        ...
        <div className="mt-12 text-center">
          <button className="bg-[#6a0dad] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-xl font-semibold transition-transform transform hover:scale-105 hover:bg-[#5a0ca3] duration-300">
            Gerar Relatório PDF
          </button>
        </div>
      </div>
